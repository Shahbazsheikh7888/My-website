...
const Contactme = () => {
  return (
    <>
      <div name="contact" className='max-w-[1240px] m-auto pt-8 mt-8 pb-5'>
        <form  className='max-w-[500px] m-auto pt-10 pl-2'>
          ...
          <div className="flex justify-center mt-5"> <button className=' text-2xl border rounded-full  bg-purple-600 hover:bg-purple-800 shadow-lg p-2 text-white w-40  mt-2'>Submit</button></div>
